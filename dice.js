...
var scores, roundScore, activePlayer, gamePlaying, winningScore = 100;
...
document.querySelector('.btn-new').addEventListener('click', showModal);

function showModal () {
  document.querySelector('.modal-wrapper').classList.remove('modal-hidden');
}
